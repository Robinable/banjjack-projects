    ...
    <div id="main_content">
        <div id="message_box">
            ...
            <ul class="top_buttons">
                <li><a href="/receptNote?recept=${user.username}">받은 쪽지함</a></li>
                <li><a href="/sendNote?send=${user.username}">보낸 쪽지함</a></li>
                <li><a name="delete" href="/deleteNote?_id=${_id}">쪽지 삭제</a></li>
            </ul>
            <div><form action="/writeNoteForm?reply=${reply}" method="post" name="message_form"></div>
                <div id="write_msg">
                    <ul>
                        <li>
