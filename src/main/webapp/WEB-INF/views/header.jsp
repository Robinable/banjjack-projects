          ...
          <div class="col-md-3 text-end">
            ...
            <div class="d-inline-flex dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-end">
                ...
                <li><div type="button" class="dropdown-item" style="background-color: #fff;" onclick="window.open('/receptNote?recept=${user.username}', 'a', 'width=880, height=650, left=100, top=50');"><i class="me-2"></i>쪽지함</div></li>
